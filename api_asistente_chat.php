...
if ((int)$count === 0) {
    $seed = [
        ...
        // ATENCIONES
        ['Atenciones', '¿Cómo hago una cotización?', 'El flujo de cotización rápida está en el Dashboard (panel Atención en Recepción). Paso 1: busca el paciente por DNI. Paso 2: confirma el paciente. Paso 3: selecciona los servicios a cotizar (consulta, laboratorio, ecografía, etc.) y genera la cotización.', 'cotizar cotizacion presupuesto servicios recepcion atenciones', 8],
        ['Atenciones', '¿Dónde veo las cotizaciones pendientes?', 'Ve a Finanzas → Atenciones. Ahí aparecen todas las cotizaciones con su estado (pendiente, cobrada, vencida). Puedes filtrar por fecha o paciente.', 'cotizaciones pendientes lista historial atenciones', 9],
        ['Atenciones', '¿Cómo cobro una cotización?', 'En Finanzas → Atenciones, selecciona la cotización y haz clic en "Cobrar". Podrás aplicar descuentos, elegir el método de pago y confirmar el cobro. Se generará el comprobante automáticamente.', 'cobrar cotizacion pago metodo descuento comprobante atenciones', 10],
        // CONSULTAS
        ...
        // DESCUENTOS
        ['Atenciones', '¿Cómo aplico un descuento?', 'Al cobrar una cotización o en el panel de cobro, hay un campo de descuento donde puedes ingresar el porcentaje o monto a descontar. También existen descuentos predefinidos que el administrador configura en Descuentos.', 'descuento aplicar cobro porcentaje promocion atenciones', 30],
        // ECOGRAFÍA / IMAGEN
        ...
        // COMPROBANTE
        ['Atenciones', '¿Cómo genero un comprobante o factura?', 'Después de cobrar una cotización, el sistema genera automáticamente un comprobante. Puedes imprimirlo o descargarlo en PDF desde el detalle del cobro en la sección Atenciones.', 'comprobante factura imprimir pdf cobro recibo atenciones', 33],
    ];
