...
function PacienteDatosBasicos({ form, handleChange }) {
  return (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          ...
          <label className="block text-sm font-medium text-gray-700 mb-1">
            {form.tipo_documento === "dni" ? "DNI" : form.tipo_documento === "carnet_extranjeria" ? "Carnet de extranjería" : "DNI Provisional"}
          </label>
          <input
            name="dni"
            value={form.dni}
            onChange={handleChange}
            placeholder={form.tipo_documento === "dni" ? "Documento de identidad (8 dígitos)" : form.tipo_documento === "carnet_extranjeria" ? "Carnet de extranjería (12 dígitos)" : "Se genera automáticamente"}
            ...
            required={form.tipo_documento !== "sin_documento"}
          />
        </div>
        <div>
...
export default PacienteDatosBasicos;
