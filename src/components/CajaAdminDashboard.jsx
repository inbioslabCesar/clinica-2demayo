                ...
                {(() => {
                  ...
                  if (cajasRecep.length > 0) {
                    return cajasRecep.map((caja, idx) => {
                      // Aseguramos que los ingresos por pago y servicio sean solo de la caja actual
                        ...
                        >
                          ...
                          <div>
                            ...
                            <div className="flex flex-wrap gap-2">
                              {ingresosPorPago.length > 0 ? (
                                ingresosPorPago.map((pago, i) => {
                                  let color = "green";
                                  let icon = (
                          ...
                          <div>
                            ...
                            <div className="flex flex-wrap gap-2">
                              {ingresosPorServicio.length > 0 ? (
                                ingresosPorServicio.map((serv, j) => {
                                  let color = "purple";
                                  let icon = (
