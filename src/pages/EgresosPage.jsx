  ...
  return (
    <div className="w-full max-w-[1600px] mx-auto p-6">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-8 mb-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-orange-200 flex flex-col items-center justify-center px-10 py-8 min-w-[260px] cursor-pointer hover:scale-105 transition" onClick={() => navigate("/contabilidad/descuentos") }>
          <div className="mb-2">
