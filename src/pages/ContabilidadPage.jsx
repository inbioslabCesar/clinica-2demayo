  ...
  return (
    <div className="min-h-screen bg-blue-50 p-6">
      ...
      <p className="mb-8 text-gray-700 text-lg">
        Gestión de ingresos y egresos por área
      </p>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <button
          onClick={() => navigate("/contabilidad/ingresos")}
          className="bg-green-500 hover:bg-green-600 text-white rounded-xl p-8 shadow-lg text-2xl font-bold flex flex-col items-center gap-2"
        >
          <span>💵</span>
          Ingresos
          <span className="text-base font-normal">
            Registro de ingresos por área y servicio
          </span>
        </button>
        <button
          onClick={() => navigate("/contabilidad/egresos")}
          className="bg-red-500 hover:bg-red-600 text-white rounded-xl p-8 shadow-lg text-2xl font-bold flex flex-col items-center gap-2"
        >
          <span>💸</span>
          Egresos
          <span className="text-base font-normal">
            Registro de gastos y egresos operativos
          </span>
        </button>
