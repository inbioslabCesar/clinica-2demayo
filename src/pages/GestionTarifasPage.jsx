...
function GestionTarifasPage() {
  ...
  const guardarTarifa = async () => {
    ...
    try {
      ...
      // DEBUG: Log para ver la respuesta del servidor
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-blue-700">
              <ul className="list-disc list-inside space-y-1">
                <li><strong>🏥 Servicios Médicos:</strong> Puedes crear y editar tarifas para consultas, procedimientos, cirugías, etc.</li>
                <li><strong>🧪 Laboratorio:</strong> Los precios se gestionan desde su módulo específico. Aquí solo se visualizan.</li>
                <li><strong>💊 Farmacia:</strong> Los precios se calculan automáticamente desde el costo + margen de ganancia.</li>
              </ul>
            </div>
          </div>
        </div>
