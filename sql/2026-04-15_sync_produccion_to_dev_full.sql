-- Sync de esquema PRODUCCION -> DESARROLLO
...
CREATE TABLE IF NOT EXISTS `vw_cotizaciones_resumen_diario` (
`estado` varchar(20)
,`fecha` datetime
,`fecha_dia` date
...
-- 2) Sincronizar columnas en tablas existentes
ALTER TABLE `atenciones` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `atenciones` MODIFY COLUMN `observaciones` text COLLATE utf8mb4_general_ci;
ALTER TABLE `atenciones` MODIFY COLUMN `fecha` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `atenciones` MODIFY COLUMN `usuario_id` int NOT NULL;
ALTER TABLE `atenciones` MODIFY COLUMN `servicio` enum('consulta','laboratorio','farmacia','rayosx','ecografia','procedimiento','operacion','hospitalizacion','ocupacional','procedimientos','cirugias','tratamientos','emergencias') COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `atenciones` MODIFY COLUMN `estado` enum('pendiente','en_proceso','finalizado') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'pendiente';
ALTER TABLE `atenciones` MODIFY COLUMN `paciente_id` int NOT NULL;
ALTER TABLE `cajas` MODIFY COLUMN `observaciones_cierre` text COLLATE utf8mb4_general_ci;
ALTER TABLE `cajas` MODIFY COLUMN `turno` enum('mañana','tarde','noche') COLLATE utf8mb4_general_ci NOT NULL;
ALTER TABLE `cajas` MODIFY COLUMN `monto_apertura` decimal(10,2) NOT NULL DEFAULT '0.00';
ALTER TABLE `cajas` MODIFY COLUMN `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `cajas` MODIFY COLUMN `total_transferencias` decimal(10,2) DEFAULT '0.00';
ALTER TABLE `cajas` MODIFY COLUMN `total_efectivo` decimal(10,2) DEFAULT '0.00';
ALTER TABLE `cajas` MODIFY COLUMN `usuario_id` int NOT NULL;
ALTER TABLE `cajas` MODIFY COLUMN `egreso_electronico` decimal(10,2) DEFAULT '0.00';
ALTER TABLE `cajas` MODIFY COLUMN `diferencia` decimal(10,2) DEFAULT '0.00';
ALTER TABLE `cajas` MODIFY COLUMN `egreso_lab_ref` decimal(10,2) NOT NULL DEFAULT '0.00';
ALTER TABLE `cajas` MODIFY COLUMN `total_otros` decimal(10,2) DEFAULT '0.00';
ALTER TABLE `cajas` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `cajas` MODIFY COLUMN `estado` enum('abierta','en_cierre','cerrada') COLLATE utf8mb4_general_ci DEFAULT 'abierta';
ALTER TABLE `cajas` MODIFY COLUMN `egreso_operativo` decimal(10,2) NOT NULL DEFAULT '0.00';
ALTER TABLE `cajas` MODIFY COLUMN `monto_contado` decimal(10,2) DEFAULT '0.00';
ALTER TABLE `cajas` MODIFY COLUMN `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `cajas` MODIFY COLUMN `total_tarjetas` decimal(10,2) DEFAULT '0.00';
ALTER TABLE `cajas` MODIFY COLUMN `observaciones_apertura` text COLLATE utf8mb4_general_ci;
ALTER TABLE `cajas` MODIFY COLUMN `total_yape` decimal(10,2) NOT NULL DEFAULT '0.00';
ALTER TABLE `cajas` MODIFY COLUMN `total_plin` decimal(10,2) NOT NULL DEFAULT '0.00';
ALTER TABLE `cajas` MODIFY COLUMN `total_egresos` decimal(10,2) NOT NULL DEFAULT '0.00';
ALTER TABLE `cajas` MODIFY COLUMN `egreso_honorarios` decimal(10,2) NOT NULL DEFAULT '0.00';
ALTER TABLE `cie10` MODIFY COLUMN `codigo` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL;
ALTER TABLE `cie10` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `cie10` MODIFY COLUMN `nombre` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL;
ALTER TABLE `cie10` MODIFY COLUMN `actualizado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `cie10` MODIFY COLUMN `creado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `cie10` MODIFY COLUMN `categoria` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL;
ALTER TABLE `cie10` MODIFY COLUMN `descripcion` text COLLATE utf8mb4_unicode_ci;
ALTER TABLE `cie10` MODIFY COLUMN `subcategoria` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL;
ALTER TABLE `cie10` MODIFY COLUMN `activo` tinyint(1) DEFAULT '1';
ALTER TABLE `cierre_caja_detalle` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `cierre_caja_detalle` MODIFY COLUMN `tarjetas_contado` decimal(10,2) DEFAULT '0.00';
ALTER TABLE `cierre_caja_detalle` MODIFY COLUMN `otros_sistema` decimal(10,2) DEFAULT '0.00';
ALTER TABLE `cierre_caja_detalle` MODIFY COLUMN `efectivo_sistema` decimal(10,2) DEFAULT '0.00';
ALTER TABLE `cierre_caja_detalle` MODIFY COLUMN `diferencia_otros` decimal(10,2) DEFAULT '0.00';
ALTER TABLE `cierre_caja_detalle` MODIFY COLUMN `diferencia_tarjetas` decimal(10,2) DEFAULT '0.00';
ALTER TABLE `cierre_caja_detalle` MODIFY COLUMN `usuario_cierre_id` int NOT NULL;
ALTER TABLE `cierre_caja_detalle` MODIFY COLUMN `diferencia_transferencias` decimal(10,2) DEFAULT '0.00';
ALTER TABLE `cierre_caja_detalle` MODIFY COLUMN `tarjetas_sistema` decimal(10,2) DEFAULT '0.00';
ALTER TABLE `cierre_caja_detalle` MODIFY COLUMN `efectivo_contado` decimal(10,2) DEFAULT '0.00';
ALTER TABLE `cierre_caja_detalle` MODIFY COLUMN `diferencia_efectivo` decimal(10,2) DEFAULT '0.00';
ALTER TABLE `cierre_caja_detalle` MODIFY COLUMN `otros_contado` decimal(10,2) DEFAULT '0.00';
ALTER TABLE `cierre_caja_detalle` MODIFY COLUMN `diferencia_total` decimal(10,2) DEFAULT '0.00';
ALTER TABLE `cierre_caja_detalle` MODIFY COLUMN `fecha_cierre` timestamp NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `cierre_caja_detalle` MODIFY COLUMN `transferencias_contado` decimal(10,2) DEFAULT '0.00';
ALTER TABLE `cierre_caja_detalle` MODIFY COLUMN `caja_id` int NOT NULL;
ALTER TABLE `cierre_caja_detalle` MODIFY COLUMN `observaciones` text COLLATE utf8mb4_general_ci;
ALTER TABLE `cierre_caja_detalle` MODIFY COLUMN `transferencias_sistema` decimal(10,2) DEFAULT '0.00';
ALTER TABLE `cobros` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `cobros` MODIFY COLUMN `observaciones` text COLLATE utf8mb4_general_ci;
ALTER TABLE `cobros` MODIFY COLUMN `usuario_id` int NOT NULL;
ALTER TABLE `cobros` MODIFY COLUMN `fecha_cobro` datetime DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `cobros` MODIFY COLUMN `tipo_pago` enum('efectivo','tarjeta','transferencia','yape','plin','seguro','otros') COLLATE utf8mb4_general_ci NOT NULL;
ALTER TABLE `cobros` MODIFY COLUMN `turno` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `cobros` MODIFY COLUMN `estado` enum('pendiente','pagado','anulado','devolucion') COLLATE utf8mb4_general_ci DEFAULT 'pendiente';
ALTER TABLE `cobros` MODIFY COLUMN `paciente_id` int DEFAULT NULL;
ALTER TABLE `cobros_detalle` MODIFY COLUMN `cantidad` int DEFAULT '1';
ALTER TABLE `cobros_detalle` MODIFY COLUMN `servicio_tipo` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL;
ALTER TABLE `cobros_detalle` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `cobros_detalle` MODIFY COLUMN `servicio_id` int DEFAULT NULL;
ALTER TABLE `cobros_detalle` MODIFY COLUMN `descripcion` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin;
ALTER TABLE `cobros_detalle` MODIFY COLUMN `cobro_id` int NOT NULL;
ALTER TABLE `configuracion_clinica` MODIFY COLUMN `especialidades` text COLLATE utf8mb4_general_ci;
...
ALTER TABLE `configuracion_clinica` MODIFY COLUMN `contacto_emergencias` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL;
...
ALTER TABLE `configuracion_clinica` MODIFY COLUMN `nombre_clinica` varchar(255) COLLATE utf8mb4_general_ci NOT NULL;
...
ALTER TABLE `configuracion_clinica` MODIFY COLUMN `valores` text COLLATE utf8mb4_general_ci;
...
ALTER TABLE `configuracion_clinica` MODIFY COLUMN `director_general` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `configuracion_clinica` MODIFY COLUMN `jefe_enfermeria` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `configuracion_clinica` MODIFY COLUMN `mision` text COLLATE utf8mb4_general_ci;
...
ALTER TABLE `configuracion_clinica` MODIFY COLUMN `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE `configuracion_clinica` MODIFY COLUMN `ruc` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL;
...
ALTER TABLE `configuracion_clinica` MODIFY COLUMN `horario_atencion` text COLLATE utf8mb4_general_ci;
ALTER TABLE `configuracion_clinica` MODIFY COLUMN `email` varchar(100) COLLATE utf8mb4_general_ci NOT NULL;
...
ALTER TABLE `configuracion_clinica` MODIFY COLUMN `vision` text COLLATE utf8mb4_general_ci;
...
ALTER TABLE `configuracion_clinica` MODIFY COLUMN `direccion` text COLLATE utf8mb4_general_ci NOT NULL;
ALTER TABLE `configuracion_clinica` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `configuracion_clinica` MODIFY COLUMN `logo_url` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL;
...
ALTER TABLE `configuracion_clinica` MODIFY COLUMN `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
...
ALTER TABLE `configuracion_clinica` MODIFY COLUMN `website` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `configuracion_clinica` ADD COLUMN IF NOT EXISTS `celular` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `configuracion_clinica` MODIFY COLUMN `telefono` varchar(20) COLLATE utf8mb4_general_ci NOT NULL;
...
ALTER TABLE `configuracion_honorarios_medicos` MODIFY COLUMN `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `configuracion_honorarios_medicos` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `configuracion_honorarios_medicos` MODIFY COLUMN `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `configuracion_honorarios_medicos` MODIFY COLUMN `activo` tinyint(1) DEFAULT '1';
ALTER TABLE `configuracion_honorarios_medicos` MODIFY COLUMN `vigencia_desde` date DEFAULT NULL;
ALTER TABLE `configuracion_honorarios_medicos` MODIFY COLUMN `tipo_servicio` enum('consulta','procedimiento','cirugia','interconsulta','otros') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'consulta';
ALTER TABLE `configuracion_honorarios_medicos` MODIFY COLUMN `observaciones` text COLLATE utf8mb4_unicode_ci;
ALTER TABLE `configuracion_honorarios_medicos` MODIFY COLUMN `tarifa_id` int DEFAULT NULL;
ALTER TABLE `configuracion_honorarios_medicos` MODIFY COLUMN `especialidad` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL;
ALTER TABLE `configuracion_honorarios_medicos` MODIFY COLUMN `medico_id` int NOT NULL;
ALTER TABLE `consultas` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `consultas` ADD COLUMN IF NOT EXISTS `es_reprogramada` tinyint(1) NOT NULL DEFAULT '0';
ALTER TABLE `consultas` MODIFY COLUMN `tipo_consulta` enum('programada','espontanea') COLLATE utf8mb4_general_ci DEFAULT 'programada';
ALTER TABLE `consultas` MODIFY COLUMN `cobro_id` int DEFAULT NULL;
ALTER TABLE `consultas` MODIFY COLUMN `paciente_id` int NOT NULL;
...
ALTER TABLE `consultas` MODIFY COLUMN `triaje_realizado` tinyint(1) NOT NULL DEFAULT '0';
ALTER TABLE `consultas` MODIFY COLUMN `estado` enum('pendiente','falta_cancelar','completada','cancelada') COLLATE utf8mb4_general_ci DEFAULT 'pendiente';
ALTER TABLE `consultas` MODIFY COLUMN `medico_id` int NOT NULL;
ALTER TABLE `consultas` MODIFY COLUMN `clasificacion` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `cotizaciones` MODIFY COLUMN `id` int NOT NULL;
...
ALTER TABLE `cotizaciones` MODIFY COLUMN `paciente_id` int NOT NULL;
...
ALTER TABLE `cotizaciones` MODIFY COLUMN `fecha` datetime DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `cotizaciones` MODIFY COLUMN `usuario_id` int NOT NULL;
...
ALTER TABLE `cotizaciones` MODIFY COLUMN `estado` varchar(20) COLLATE utf8mb4_general_ci DEFAULT 'pendiente';
ALTER TABLE `cotizaciones` ADD COLUMN IF NOT EXISTS `version_actual` int NOT NULL DEFAULT '1';
ALTER TABLE `cotizaciones` MODIFY COLUMN `observaciones` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `cotizaciones_detalle` ADD COLUMN IF NOT EXISTS `consulta_id` int DEFAULT NULL;
ALTER TABLE `cotizaciones_detalle` MODIFY COLUMN `cantidad` int DEFAULT '1';
ALTER TABLE `cotizaciones_detalle` MODIFY COLUMN `servicio_id` int DEFAULT NULL;
...
ALTER TABLE `cotizaciones_detalle` MODIFY COLUMN `servicio_tipo` varchar(30) COLLATE utf8mb4_general_ci NOT NULL;
...
ALTER TABLE `cotizaciones_detalle` MODIFY COLUMN `cotizacion_id` int NOT NULL;
...
ALTER TABLE `cotizaciones_detalle` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `cotizaciones_detalle` MODIFY COLUMN `descripcion` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL;
...
ALTER TABLE `cotizaciones_farmacia` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `cotizaciones_farmacia` MODIFY COLUMN `observaciones` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `cotizaciones_farmacia` MODIFY COLUMN `fecha` datetime DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `cotizaciones_farmacia` MODIFY COLUMN `usuario_id` int NOT NULL;
ALTER TABLE `cotizaciones_farmacia` MODIFY COLUMN `paciente_dni` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `cotizaciones_farmacia` MODIFY COLUMN `paciente_nombre` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `cotizaciones_farmacia` MODIFY COLUMN `estado` varchar(20) COLLATE utf8mb4_general_ci DEFAULT 'pendiente';
ALTER TABLE `cotizaciones_farmacia` MODIFY COLUMN `paciente_id` int DEFAULT NULL;
ALTER TABLE `cotizaciones_farmacia_detalle` MODIFY COLUMN `cantidad` int DEFAULT '1';
ALTER TABLE `cotizaciones_farmacia_detalle` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `cotizaciones_farmacia_detalle` MODIFY COLUMN `cotizacion_id` int NOT NULL;
ALTER TABLE `cotizaciones_farmacia_detalle` MODIFY COLUMN `medicamento_id` int NOT NULL;
ALTER TABLE `cotizaciones_farmacia_detalle` MODIFY COLUMN `descripcion` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `descuentos_aplicados` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `descuentos_aplicados` MODIFY COLUMN `cobro_id` int NOT NULL;
ALTER TABLE `descuentos_aplicados` MODIFY COLUMN `paciente_id` int NOT NULL;
ALTER TABLE `descuentos_aplicados` MODIFY COLUMN `servicio` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL;
ALTER TABLE `descuentos_aplicados` MODIFY COLUMN `created_at` datetime DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `descuentos_aplicados` MODIFY COLUMN `paciente_nombre` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL;
ALTER TABLE `descuentos_aplicados` MODIFY COLUMN `usuario_nombre` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL;
ALTER TABLE `descuentos_aplicados` MODIFY COLUMN `motivo` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL;
ALTER TABLE `descuentos_aplicados` MODIFY COLUMN `usuario_id` int NOT NULL;
ALTER TABLE `descuentos_aplicados` MODIFY COLUMN `tipo_descuento` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL;
ALTER TABLE `disponibilidad_medicos` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `disponibilidad_medicos` MODIFY COLUMN `dia_semana` enum('lunes','martes','miércoles','jueves','viernes','sábado','domingo') COLLATE utf8mb4_general_ci NOT NULL;
ALTER TABLE `disponibilidad_medicos` MODIFY COLUMN `medico_id` int NOT NULL;
ALTER TABLE `egresos` MODIFY COLUMN `observaciones` text COLLATE utf8mb4_unicode_ci;
ALTER TABLE `egresos` MODIFY COLUMN `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `egresos` MODIFY COLUMN `tipo_egreso` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL;
ALTER TABLE `egresos` MODIFY COLUMN `usuario_id` int DEFAULT NULL;
ALTER TABLE `egresos` MODIFY COLUMN `liquidacion_id` int DEFAULT NULL;
ALTER TABLE `egresos` MODIFY COLUMN `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `egresos` MODIFY COLUMN `medico_id` int DEFAULT NULL;
ALTER TABLE `egresos` MODIFY COLUMN `categoria` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL;
ALTER TABLE `egresos` MODIFY COLUMN `honorario_movimiento_id` int DEFAULT NULL;
ALTER TABLE `egresos` MODIFY COLUMN `metodo_pago` enum('efectivo','transferencia','tarjeta','yape','plin','cheque','deposito') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'efectivo';
ALTER TABLE `egresos` MODIFY COLUMN `tipo` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL;
ALTER TABLE `egresos` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `egresos` MODIFY COLUMN `estado` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'pendiente';
ALTER TABLE `egresos` MODIFY COLUMN `concepto` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL;
ALTER TABLE `egresos` MODIFY COLUMN `caja_id` int DEFAULT NULL;
ALTER TABLE `egresos` MODIFY COLUMN `descripcion` text COLLATE utf8mb4_unicode_ci;
ALTER TABLE `egresos` MODIFY COLUMN `turno` enum('mañana','tarde','noche') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'mañana';
ALTER TABLE `egresos` MODIFY COLUMN `responsable` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL;
ALTER TABLE `examenes_laboratorio` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `examenes_laboratorio` MODIFY COLUMN `nombre` varchar(100) COLLATE utf8mb4_general_ci NOT NULL;
ALTER TABLE `examenes_laboratorio` MODIFY COLUMN `tipo_frasco` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `examenes_laboratorio` MODIFY COLUMN `activo` tinyint(1) DEFAULT '1';
ALTER TABLE `examenes_laboratorio` MODIFY COLUMN `creado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `examenes_laboratorio` MODIFY COLUMN `preanalitica` text COLLATE utf8mb4_general_ci;
ALTER TABLE `examenes_laboratorio` MODIFY COLUMN `categoria` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `examenes_laboratorio` MODIFY COLUMN `tipo_tubo` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `examenes_laboratorio` MODIFY COLUMN `metodologia` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `examenes_laboratorio` MODIFY COLUMN `condicion_paciente` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `examenes_laboratorio` MODIFY COLUMN `tiempo_resultado` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `examenes_laboratorio` MODIFY COLUMN `valores_referenciales` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin;
ALTER TABLE `historia_clinica` MODIFY COLUMN `datos` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL;
ALTER TABLE `historia_clinica` MODIFY COLUMN `consulta_id` int NOT NULL;
ALTER TABLE `historia_clinica` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `historia_clinica` MODIFY COLUMN `fecha_registro` datetime DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `honorarios_medicos_movimientos` MODIFY COLUMN `consulta_id` int DEFAULT NULL;
ALTER TABLE `honorarios_medicos_movimientos` MODIFY COLUMN `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `honorarios_medicos_movimientos` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `honorarios_medicos_movimientos` MODIFY COLUMN `liquidacion_id` int DEFAULT NULL;
ALTER TABLE `honorarios_medicos_movimientos` MODIFY COLUMN `cobro_id` int DEFAULT NULL;
ALTER TABLE `honorarios_medicos_movimientos` MODIFY COLUMN `paciente_id` int DEFAULT NULL;
ALTER TABLE `honorarios_medicos_movimientos` MODIFY COLUMN `observaciones` text COLLATE utf8mb4_unicode_ci;
ALTER TABLE `honorarios_medicos_movimientos` MODIFY COLUMN `metodo_pago_medico` enum('efectivo','transferencia','cheque','deposito','tarjeta','yape','plin') COLLATE utf8mb4_unicode_ci DEFAULT NULL;
ALTER TABLE `honorarios_medicos_movimientos` MODIFY COLUMN `tipo_precio` enum('particular','seguro','convenio') COLLATE utf8mb4_unicode_ci DEFAULT 'particular';
ALTER TABLE `honorarios_medicos_movimientos` MODIFY COLUMN `tipo_servicio` enum('consulta','rayosx','ecografia','ocupacional','procedimientos','cirugias','tratamientos','emergencias','operacion','hospitalizacion') COLLATE utf8mb4_unicode_ci DEFAULT NULL;
ALTER TABLE `honorarios_medicos_movimientos` MODIFY COLUMN `turno` enum('mañana','tarde','noche') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'mañana';
ALTER TABLE `honorarios_medicos_movimientos` MODIFY COLUMN `tarifa_id` int DEFAULT NULL;
ALTER TABLE `honorarios_medicos_movimientos` MODIFY COLUMN `caja_id` int DEFAULT NULL;
ALTER TABLE `honorarios_medicos_movimientos` MODIFY COLUMN `descripcion` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL;
ALTER TABLE `honorarios_medicos_movimientos` MODIFY COLUMN `medico_id` int NOT NULL;
ALTER TABLE `honorarios_medicos_movimientos` MODIFY COLUMN `estado_pago_medico` enum('pendiente','pagado','cancelado') COLLATE utf8mb4_unicode_ci DEFAULT 'pendiente';
ALTER TABLE `ingresos` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `ingresos` MODIFY COLUMN `caja_id` int NOT NULL;
ALTER TABLE `ingresos` MODIFY COLUMN `usuario_id` int NOT NULL;
ALTER TABLE `ingresos` MODIFY COLUMN `tipo_pago` enum('efectivo','tarjeta','transferencia','yape','plin','otros') COLLATE utf8mb4_unicode_ci NOT NULL;
ALTER TABLE `ingresos` MODIFY COLUMN `descripcion` text COLLATE utf8mb4_unicode_ci;
ALTER TABLE `ingresos` MODIFY COLUMN `area` enum('consulta','laboratorio','farmacia','ecografia','rayosx','procedimiento','otros') COLLATE utf8mb4_unicode_ci NOT NULL;
ALTER TABLE `ingresos_diarios` MODIFY COLUMN `referencia_tabla` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `ingresos_diarios` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `ingresos_diarios` MODIFY COLUMN `cobrado_por` int DEFAULT NULL;
ALTER TABLE `ingresos_diarios` MODIFY COLUMN `paciente_id` int DEFAULT NULL;
ALTER TABLE `ingresos_diarios` MODIFY COLUMN `turno` enum('mañana','tarde','noche') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'mañana';
ALTER TABLE `ingresos_diarios` MODIFY COLUMN `paciente_nombre` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `ingresos_diarios` MODIFY COLUMN `tipo_ingreso` enum('consulta','laboratorio','farmacia','ecografia','rayosx','procedimiento','otros','operaciones') COLLATE utf8mb4_general_ci NOT NULL;
ALTER TABLE `ingresos_diarios` MODIFY COLUMN `fecha_hora` timestamp NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `ingresos_diarios` MODIFY COLUMN `honorario_movimiento_id` int DEFAULT NULL;
ALTER TABLE `ingresos_diarios` MODIFY COLUMN `metodo_pago` enum('efectivo','tarjeta','transferencia','yape','plin','seguro','otros') COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `ingresos_diarios` MODIFY COLUMN `usuario_id` int NOT NULL;
ALTER TABLE `ingresos_diarios` MODIFY COLUMN `referencia_id` int DEFAULT NULL;
ALTER TABLE `ingresos_diarios` MODIFY COLUMN `caja_id` int NOT NULL;
ALTER TABLE `ingresos_diarios` MODIFY COLUMN `descripcion` text COLLATE utf8mb4_general_ci NOT NULL;
ALTER TABLE `ingresos_diarios` MODIFY COLUMN `liquidado_por` int DEFAULT NULL;
ALTER TABLE `ingresos_diarios` MODIFY COLUMN `area` varchar(100) COLLATE utf8mb4_general_ci NOT NULL;
ALTER TABLE `laboratorio_referencia_movimientos` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `laboratorio_referencia_movimientos` MODIFY COLUMN `cobro_id` int NOT NULL;
ALTER TABLE `laboratorio_referencia_movimientos` MODIFY COLUMN `cobrado_por` int DEFAULT NULL;
ALTER TABLE `laboratorio_referencia_movimientos` MODIFY COLUMN `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `laboratorio_referencia_movimientos` ADD COLUMN IF NOT EXISTS `cotizacion_id` int DEFAULT NULL;
ALTER TABLE `laboratorio_referencia_movimientos` MODIFY COLUMN `observaciones` text COLLATE utf8mb4_unicode_ci;
ALTER TABLE `laboratorio_referencia_movimientos` MODIFY COLUMN `turno_cobro` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL;
ALTER TABLE `laboratorio_referencia_movimientos` MODIFY COLUMN `hora_liquidacion` varchar(8) COLLATE utf8mb4_unicode_ci DEFAULT NULL;
ALTER TABLE `laboratorio_referencia_movimientos` MODIFY COLUMN `examen_id` int NOT NULL;
ALTER TABLE `laboratorio_referencia_movimientos` MODIFY COLUMN `laboratorio` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL;
ALTER TABLE `laboratorio_referencia_movimientos` MODIFY COLUMN `hora_cobro` varchar(8) COLLATE utf8mb4_unicode_ci DEFAULT NULL;
ALTER TABLE `laboratorio_referencia_movimientos` MODIFY COLUMN `paciente_id` int DEFAULT NULL;
ALTER TABLE `laboratorio_referencia_movimientos` MODIFY COLUMN `tipo` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL;
ALTER TABLE `laboratorio_referencia_movimientos` MODIFY COLUMN `estado` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pendiente';
ALTER TABLE `laboratorio_referencia_movimientos` MODIFY COLUMN `caja_id` int DEFAULT NULL;
ALTER TABLE `laboratorio_referencia_movimientos` MODIFY COLUMN `turno_liquidacion` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL;
ALTER TABLE `laboratorio_referencia_movimientos` MODIFY COLUMN `liquidado_por` int DEFAULT NULL;
ALTER TABLE `liquidaciones_medicos` MODIFY COLUMN `observaciones` text COLLATE utf8mb4_unicode_ci;
ALTER TABLE `liquidaciones_medicos` MODIFY COLUMN `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `liquidaciones_medicos` MODIFY COLUMN `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `liquidaciones_medicos` MODIFY COLUMN `descuentos` decimal(10,2) DEFAULT '0.00';
ALTER TABLE `liquidaciones_medicos` MODIFY COLUMN `metodo_pago` enum('efectivo','transferencia','cheque','deposito') COLLATE utf8mb4_unicode_ci DEFAULT NULL;
ALTER TABLE `liquidaciones_medicos` MODIFY COLUMN `usuario_pago` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL;
ALTER TABLE `liquidaciones_medicos` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `liquidaciones_medicos` MODIFY COLUMN `estado` enum('borrador','aprobada','pagada','cancelada') COLLATE utf8mb4_unicode_ci DEFAULT 'borrador';
ALTER TABLE `liquidaciones_medicos` MODIFY COLUMN `medico_id` int NOT NULL;
ALTER TABLE `liquidaciones_medicos` MODIFY COLUMN `usuario_aprobacion` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL;
ALTER TABLE `log_eliminaciones` MODIFY COLUMN `paciente_id` int DEFAULT NULL;
ALTER TABLE `log_eliminaciones` MODIFY COLUMN `servicio_tipo` varchar(50) COLLATE utf8mb4_general_ci NOT NULL;
ALTER TABLE `log_eliminaciones` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `log_eliminaciones` MODIFY COLUMN `motivo` text COLLATE utf8mb4_general_ci;
ALTER TABLE `log_eliminaciones` MODIFY COLUMN `caja_id` int DEFAULT NULL;
ALTER TABLE `log_eliminaciones` MODIFY COLUMN `usuario_id` int NOT NULL;
ALTER TABLE `log_eliminaciones` MODIFY COLUMN `item_json` text COLLATE utf8mb4_general_ci NOT NULL;
ALTER TABLE `log_eliminaciones` MODIFY COLUMN `cobros_detalle_id` int DEFAULT NULL;
ALTER TABLE `log_eliminaciones` MODIFY COLUMN `fecha_hora` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `log_eliminaciones` MODIFY COLUMN `cobro_id` int NOT NULL;
ALTER TABLE `log_reaperturas` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `log_reaperturas` MODIFY COLUMN `fecha_reapertura` timestamp NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `log_reaperturas` MODIFY COLUMN `motivo` text COLLATE utf8mb4_general_ci;
ALTER TABLE `log_reaperturas` MODIFY COLUMN `caja_id` int NOT NULL;
ALTER TABLE `log_reaperturas` MODIFY COLUMN `usuario_id` int NOT NULL;
ALTER TABLE `log_reaperturas` MODIFY COLUMN `usuario_nombre` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `log_reaperturas` MODIFY COLUMN `datos_cierre_anterior` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin;
ALTER TABLE `medicamentos` MODIFY COLUMN `codigo` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `medicamentos` MODIFY COLUMN `concentracion` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `medicamentos` MODIFY COLUMN `stock` int DEFAULT '0';
ALTER TABLE `medicamentos` MODIFY COLUMN `presentacion` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `medicamentos` MODIFY COLUMN `fecha_registro` timestamp NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `medicamentos` MODIFY COLUMN `fecha_actualizacion` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `medicamentos` MODIFY COLUMN `margen_ganancia` decimal(5,2) NOT NULL DEFAULT '30.00';
ALTER TABLE `medicamentos` MODIFY COLUMN `motivo_cuarentena` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `medicamentos` MODIFY COLUMN `laboratorio` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `medicamentos` MODIFY COLUMN `unidades_por_caja` int NOT NULL DEFAULT '1';
ALTER TABLE `medicamentos` MODIFY COLUMN `precio_compra` decimal(10,2) NOT NULL DEFAULT '0.00';
ALTER TABLE `medicamentos` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `medicamentos` MODIFY COLUMN `estado` enum('activo','inactivo','cuarentena') COLLATE utf8mb4_general_ci DEFAULT 'activo';
ALTER TABLE `medicamentos` MODIFY COLUMN `nombre` varchar(100) COLLATE utf8mb4_general_ci NOT NULL;
ALTER TABLE `medicos` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `medicos` MODIFY COLUMN `especialidad` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `medicos` MODIFY COLUMN `apellido` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `medicos` MODIFY COLUMN `password` varchar(255) COLLATE utf8mb4_general_ci NOT NULL;
...
ALTER TABLE `medicos` MODIFY COLUMN `firma` longtext COLLATE utf8mb4_general_ci COMMENT 'Firma digital del médico en base64';
ALTER TABLE `medicos` MODIFY COLUMN `rol` varchar(50) COLLATE utf8mb4_general_ci DEFAULT 'medico';
ALTER TABLE `medicos` ADD COLUMN IF NOT EXISTS `colegio_sigla` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `medicos` MODIFY COLUMN `rne` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `medicos` ADD COLUMN IF NOT EXISTS `nro_colegiatura` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `medicos` MODIFY COLUMN `cmp` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `medicos` MODIFY COLUMN `email` varchar(100) COLLATE utf8mb4_general_ci NOT NULL;
ALTER TABLE `medicos` MODIFY COLUMN `nombre` varchar(100) COLLATE utf8mb4_general_ci NOT NULL;
...
ALTER TABLE `metodos_pago` MODIFY COLUMN `codigo` varchar(20) COLLATE utf8mb4_general_ci NOT NULL;
ALTER TABLE `metodos_pago` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `metodos_pago` MODIFY COLUMN `nombre` varchar(50) COLLATE utf8mb4_general_ci NOT NULL;
ALTER TABLE `metodos_pago` MODIFY COLUMN `orden_visualizacion` int DEFAULT '0';
ALTER TABLE `metodos_pago` MODIFY COLUMN `requiere_referencia` tinyint(1) DEFAULT '0';
ALTER TABLE `metodos_pago` MODIFY COLUMN `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `metodos_pago` MODIFY COLUMN `descripcion` text COLLATE utf8mb4_general_ci;
ALTER TABLE `metodos_pago` MODIFY COLUMN `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `metodos_pago` MODIFY COLUMN `activo` tinyint(1) DEFAULT '1';
ALTER TABLE `movimientos_medicamento` MODIFY COLUMN `cantidad` int NOT NULL;
ALTER TABLE `movimientos_medicamento` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `movimientos_medicamento` MODIFY COLUMN `observaciones` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `movimientos_medicamento` MODIFY COLUMN `medico_id` int DEFAULT NULL;
ALTER TABLE `movimientos_medicamento` MODIFY COLUMN `usuario_id` int NOT NULL;
ALTER TABLE `movimientos_medicamento` MODIFY COLUMN `medicamento_id` int NOT NULL;
ALTER TABLE `movimientos_medicamento` MODIFY COLUMN `tipo_movimiento` varchar(20) COLLATE utf8mb4_general_ci NOT NULL;
ALTER TABLE `movimientos_medicamento` MODIFY COLUMN `fecha_hora` datetime DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `ordenes_laboratorio` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `ordenes_laboratorio` MODIFY COLUMN `cobro_id` int DEFAULT NULL;
ALTER TABLE `ordenes_laboratorio` MODIFY COLUMN `consulta_id` int DEFAULT NULL;
ALTER TABLE `ordenes_laboratorio` MODIFY COLUMN `examenes` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL;
ALTER TABLE `ordenes_laboratorio` MODIFY COLUMN `fecha` datetime DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE `ordenes_laboratorio` MODIFY COLUMN `estado` varchar(20) COLLATE utf8mb4_general_ci DEFAULT 'pendiente';
ALTER TABLE `ordenes_laboratorio` MODIFY COLUMN `paciente_id` int DEFAULT NULL;
ALTER TABLE `pacientes` MODIFY COLUMN `procedencia` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `pacientes` MODIFY COLUMN `historia_clinica` varchar(30) COLLATE utf8mb4_general_ci NOT NULL;
ALTER TABLE `pacientes` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `pacientes` MODIFY COLUMN `apellido` varchar(100) COLLATE utf8mb4_general_ci NOT NULL;
ALTER TABLE `pacientes` MODIFY COLUMN `edad` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `pacientes` MODIFY COLUMN `direccion` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `pacientes` MODIFY COLUMN `telefono` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `pacientes` MODIFY COLUMN `edad_unidad` enum('días','meses','años') COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `pacientes` MODIFY COLUMN `dni` varchar(15) COLLATE utf8mb4_general_ci NOT NULL;
ALTER TABLE `pacientes` MODIFY COLUMN `sexo` enum('M','F') COLLATE utf8mb4_general_ci NOT NULL;
ALTER TABLE `pacientes` MODIFY COLUMN `email` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `pacientes` MODIFY COLUMN `creado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `pacientes` MODIFY COLUMN `tipo_seguro` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `pacientes` MODIFY COLUMN `nombre` varchar(100) COLLATE utf8mb4_general_ci NOT NULL;
ALTER TABLE `public_banners` MODIFY COLUMN `overlay_blanco` tinyint(1) NOT NULL DEFAULT '1';
ALTER TABLE `public_banners` MODIFY COLUMN `texto_lado` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'left';
ALTER TABLE `public_banners` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `public_banners` MODIFY COLUMN `subtitulo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL;
ALTER TABLE `public_banners` MODIFY COLUMN `imagen_url` text COLLATE utf8mb4_unicode_ci NOT NULL;
ALTER TABLE `public_banners` MODIFY COLUMN `activo` tinyint(1) NOT NULL DEFAULT '1';
ALTER TABLE `public_banners` MODIFY COLUMN `creado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `public_banners` MODIFY COLUMN `actualizado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `public_banners` MODIFY COLUMN `subtitulo_tamano` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'md';
ALTER TABLE `public_banners` MODIFY COLUMN `subtitulo_color` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL;
ALTER TABLE `public_banners` MODIFY COLUMN `titulo_color` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL;
ALTER TABLE `public_banners` MODIFY COLUMN `titulo_tamano` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'lg';
...
ALTER TABLE `public_banners` MODIFY COLUMN `titulo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL;
ALTER TABLE `public_banners` MODIFY COLUMN `imagen_fija_url` text COLLATE utf8mb4_unicode_ci;
ALTER TABLE `public_banners` MODIFY COLUMN `orden` int NOT NULL DEFAULT '0';
ALTER TABLE `public_ofertas` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `public_ofertas` MODIFY COLUMN `descripcion` text COLLATE utf8mb4_unicode_ci;
ALTER TABLE `public_ofertas` MODIFY COLUMN `imagen_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL;
ALTER TABLE `public_ofertas` MODIFY COLUMN `orden` int NOT NULL DEFAULT '0';
ALTER TABLE `public_ofertas` MODIFY COLUMN `creado_en` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `public_ofertas` MODIFY COLUMN `titulo` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL;
ALTER TABLE `public_ofertas` MODIFY COLUMN `actualizado_en` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `public_ofertas` MODIFY COLUMN `activo` tinyint(1) NOT NULL DEFAULT '1';
ALTER TABLE `public_servicios` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `public_servicios` MODIFY COLUMN `activo` tinyint(1) NOT NULL DEFAULT '1';
ALTER TABLE `public_servicios` MODIFY COLUMN `creado_en` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `public_servicios` MODIFY COLUMN `actualizado_en` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP;
...
ALTER TABLE `public_servicios` MODIFY COLUMN `icono` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL;
ALTER TABLE `public_servicios` MODIFY COLUMN `descripcion` text COLLATE utf8mb4_unicode_ci;
ALTER TABLE `public_servicios` MODIFY COLUMN `titulo` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL;
ALTER TABLE `public_servicios` MODIFY COLUMN `imagen_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL;
ALTER TABLE `public_servicios` MODIFY COLUMN `orden` int NOT NULL DEFAULT '0';
ALTER TABLE `resultados_laboratorio` ADD COLUMN IF NOT EXISTS `firmado_por_usuario_id` int DEFAULT NULL;
ALTER TABLE `resultados_laboratorio` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `resultados_laboratorio` MODIFY COLUMN `orden_id` int DEFAULT NULL;
ALTER TABLE `resultados_laboratorio` MODIFY COLUMN `consulta_id` int DEFAULT NULL;
ALTER TABLE `resultados_laboratorio` MODIFY COLUMN `tipo_examen` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `resultados_laboratorio` MODIFY COLUMN `fecha` datetime DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `resultados_laboratorio` MODIFY COLUMN `resultados` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin;
ALTER TABLE `seguros` MODIFY COLUMN `numero` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `seguros` MODIFY COLUMN `tipo` varchar(50) COLLATE utf8mb4_general_ci NOT NULL;
ALTER TABLE `seguros` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `seguros` MODIFY COLUMN `paciente_id` int NOT NULL;
ALTER TABLE `tarifas` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `tarifas` MODIFY COLUMN `servicio_tipo` enum('consulta','rayosx','ecografia','ocupacional','procedimientos','cirugias','tratamientos','emergencias','operacion','hospitalizacion') COLLATE utf8mb4_general_ci DEFAULT NULL;
ALTER TABLE `tarifas` MODIFY COLUMN `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `tarifas` MODIFY COLUMN `servicio_id` int DEFAULT NULL;
ALTER TABLE `tarifas` MODIFY COLUMN `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `tarifas` MODIFY COLUMN `activo` tinyint(1) DEFAULT '1';
ALTER TABLE `tarifas` MODIFY COLUMN `descripcion` varchar(255) COLLATE utf8mb4_general_ci NOT NULL;
ALTER TABLE `tarifas` MODIFY COLUMN `medico_id` int DEFAULT NULL;
ALTER TABLE `triaje` MODIFY COLUMN `datos` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL;
ALTER TABLE `triaje` MODIFY COLUMN `consulta_id` int NOT NULL;
ALTER TABLE `triaje` MODIFY COLUMN `id` int NOT NULL;
ALTER TABLE `triaje` MODIFY COLUMN `fecha_registro` timestamp NULL DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE `usuarios` MODIFY COLUMN `password` varchar(255) COLLATE utf8mb4_general_ci NOT NULL;
ALTER TABLE `usuarios` MODIFY COLUMN `activo` tinyint(1) NOT NULL DEFAULT '1';
ALTER TABLE `usuarios` MODIFY COLUMN `creado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `usuarios` ADD COLUMN IF NOT EXISTS `permisos` text COLLATE utf8mb4_general_ci;
ALTER TABLE `usuarios` MODIFY COLUMN `rol` enum('administrador','recepcionista','laboratorista','enfermero','quimico') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'recepcionista';
ALTER TABLE `usuarios` MODIFY COLUMN `dni` varchar(15) COLLATE utf8mb4_general_ci NOT NULL;
ALTER TABLE `usuarios` MODIFY COLUMN `usuario` varchar(50) COLLATE utf8mb4_general_ci NOT NULL;
...
ALTER TABLE `usuarios` MODIFY COLUMN `profesion` varchar(100) COLLATE utf8mb4_general_ci NOT NULL;
ALTER TABLE `usuarios` MODIFY COLUMN `nombre` varchar(100) COLLATE utf8mb4_general_ci NOT NULL;

-- 3) Indices y llaves (idempotentes)
...
ALTER TABLE `atenciones` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `cajas` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `cie10` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `cierre_caja_detalle` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `cobros` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `cobros_detalle` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `configuracion_clinica` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `configuracion_honorarios_medicos` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `config_apariencia` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `consultas` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `cotizaciones` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `cotizaciones_detalle` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `cotizaciones_farmacia` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `cotizaciones_farmacia_detalle` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `cotizacion_eventos` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `cotizacion_farmacia_vinculos` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `cotizacion_item_ajustes` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `cotizacion_movimientos` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `descuentos_aplicados` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `disponibilidad_medicos` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `documentos_externos_archivos` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `documentos_externos_paciente` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `egresos` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `examenes_laboratorio` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `hc_templates` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `historia_clinica` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `historia_clinica_backups` MODIFY `id` bigint NOT NULL AUTO_INCREMENT;
ALTER TABLE `honorarios_medicos_movimientos` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `honorarios_por_cobrar` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `ingresos` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `ingresos_diarios` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `inventario_consumos_examen` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `inventario_examen_recetas` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `inventario_items` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `inventario_lotes` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `inventario_movimientos` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `inventario_transferencias` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `inventario_transferencias_detalle` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `laboratorio_referencia_movimientos` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `liquidaciones_medicos` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `log_eliminaciones` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `log_reaperturas` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `medicamentos` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `medicos` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `medico_adelantos` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `medico_condiciones_pago` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `metodos_pago` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `movimientos_medicamento` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `ordenes_imagen` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `ordenes_imagen_archivos` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `ordenes_laboratorio` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `pacientes` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `public_banners` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `public_ofertas` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `public_servicios` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `recordatorios_consultas` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `resultados_laboratorio` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `seguros` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `tarifas` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `tratamientos_ejecucion_diaria` MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
ALTER TABLE `tratamientos_ejecucion_dosis` MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
ALTER TABLE `tratamientos_ejecucion_eventos` MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
ALTER TABLE `tratamientos_enfermeria` MODIFY `id` int NOT NULL AUTO_INCREMENT;
ALTER TABLE `tratamientos_enfermeria_items` MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
ALTER TABLE `triaje` MODIFY `id` int NOT NULL AUTO_INCREMENT;
...
-- 6) Foreign keys faltantes (idempotentes)
