...
--
-- Host: localhost:3306
-- Generation Time: Apr 16, 2026 at 04:37 AM
...
--
-- Table structure for table `honorarios_por_cobrar`
--

CREATE TABLE `honorarios_por_cobrar` (
  `id` int NOT NULL,
  `cotizacion_id` int NOT NULL,
  `cobro_id` int NOT NULL,
  `consulta_id` int DEFAULT NULL,
...
--
-- Table structure for table `tratamientos_ejecucion_diaria`
--

CREATE TABLE `tratamientos_ejecucion_diaria` (
...
--
-- Table structure for table `tratamientos_ejecucion_dosis`
--

CREATE TABLE `tratamientos_ejecucion_dosis` (
  `id` bigint UNSIGNED NOT NULL,
  `tratamiento_id` int NOT NULL,
  `tratamiento_item_id` bigint UNSIGNED NOT NULL,
...
--
-- Table structure for table `tratamientos_ejecucion_eventos`
--

CREATE TABLE `tratamientos_ejecucion_eventos` (
  `id` bigint UNSIGNED NOT NULL,
  `ejecucion_diaria_id` bigint UNSIGNED NOT NULL,
  `tratamiento_id` int NOT NULL,
...
--
-- Table structure for table `tratamientos_enfermeria`
--

CREATE TABLE `tratamientos_enfermeria` (
  `id` int NOT NULL,
...
--
-- Table structure for table `tratamientos_enfermeria_items`
--

CREATE TABLE `tratamientos_enfermeria_items` (
  `id` bigint UNSIGNED NOT NULL,
  `tratamiento_id` int NOT NULL,
...
--
-- Indexes for table `honorarios_por_cobrar`
--
ALTER TABLE `honorarios_por_cobrar`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_hpc_firma_origen` (`firma_origen`),
  ADD KEY `idx_hpc_cot_estado` (`cotizacion_id`,`estado_consolidacion`),
  ADD KEY `idx_hpc_cobro` (`cobro_id`),
  ADD KEY `idx_hpc_medico_estado` (`medico_id`,`estado_consolidacion`),
  ADD KEY `idx_hpc_usuario_cobro` (`usuario_cobro_id`),
  ADD KEY `idx_hpc_hon_final` (`honorario_movimiento_id_final`),
  ADD KEY `fk_hpc_caja` (`caja_id`);
...
--
-- Indexes for table `tratamientos_ejecucion_diaria`
--
ALTER TABLE `tratamientos_ejecucion_diaria`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_te_dia_item` (`tratamiento_item_id`,`dia_nro`),
  ADD KEY `idx_te_dia_tratamiento_estado` (`tratamiento_id`,`estado_dia`),
  ADD KEY `idx_te_dia_tratamiento_numero` (`tratamiento_id`,`dia_nro`),
  ADD KEY `idx_te_dia_fecha` (`fecha_programada`);

--
-- Indexes for table `tratamientos_ejecucion_dosis`
--
ALTER TABLE `tratamientos_ejecucion_dosis`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_te_dosis_item_dia_nro` (`tratamiento_item_id`,`dia_nro`,`dosis_nro`),
  ADD KEY `idx_te_dosis_tratamiento_fecha` (`tratamiento_id`,`fecha_hora_programada`),
  ADD KEY `idx_te_dosis_diaria_estado` (`ejecucion_diaria_id`,`estado_dosis`);

--
-- Indexes for table `tratamientos_ejecucion_eventos`
--
ALTER TABLE `tratamientos_ejecucion_eventos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_te_evt_dia_fecha` (`ejecucion_diaria_id`,`fecha_hora_evento`),
  ADD KEY `idx_te_evt_trat_fecha` (`tratamiento_id`,`fecha_hora_evento`),
  ADD KEY `idx_te_evt_usuario_fecha` (`usuario_id`,`fecha_hora_evento`),
  ADD KEY `idx_te_evt_dosis` (`dosis_programada_id`);

--
-- Indexes for table `tratamientos_enfermeria`
--
ALTER TABLE `tratamientos_enfermeria`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_te_estado` (`estado`),
  ADD KEY `idx_te_paciente` (`paciente_id`),
  ADD KEY `idx_te_consulta_version` (`consulta_id`,`version_num`),
  ADD KEY `idx_te_creado` (`creado_en`);

--
-- Indexes for table `tratamientos_enfermeria_items`
--
ALTER TABLE `tratamientos_enfermeria_items`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_te_items_tratamiento` (`tratamiento_id`),
  ADD KEY `idx_te_items_orden` (`tratamiento_id`,`orden`),
  ADD KEY `idx_te_items_codigo` (`medicamento_codigo`);
...
--
-- AUTO_INCREMENT for table `honorarios_por_cobrar`
--
ALTER TABLE `honorarios_por_cobrar`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `tratamientos_ejecucion_diaria`
--
ALTER TABLE `tratamientos_ejecucion_diaria`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tratamientos_ejecucion_dosis`
--
ALTER TABLE `tratamientos_ejecucion_dosis`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tratamientos_ejecucion_eventos`
--
ALTER TABLE `tratamientos_ejecucion_eventos`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tratamientos_enfermeria`
--
ALTER TABLE `tratamientos_enfermeria`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tratamientos_enfermeria_items`
--
ALTER TABLE `tratamientos_enfermeria_items`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `honorarios_por_cobrar`
--
ALTER TABLE `honorarios_por_cobrar`
  ADD CONSTRAINT `fk_hpc_caja` FOREIGN KEY (`caja_id`) REFERENCES `cajas` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_hpc_cobro` FOREIGN KEY (`cobro_id`) REFERENCES `cobros` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_hpc_cotizacion` FOREIGN KEY (`cotizacion_id`) REFERENCES `cotizaciones` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_hpc_honorario_final` FOREIGN KEY (`honorario_movimiento_id_final`) REFERENCES `honorarios_medicos_movimientos` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_hpc_medico` FOREIGN KEY (`medico_id`) REFERENCES `medicos` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_hpc_usuario_cobro` FOREIGN KEY (`usuario_cobro_id`) REFERENCES `usuarios` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
--
-- Constraints for table `tratamientos_ejecucion_diaria`
--
ALTER TABLE `tratamientos_ejecucion_diaria`
  ADD CONSTRAINT `fk_te_dia_item` FOREIGN KEY (`tratamiento_item_id`) REFERENCES `tratamientos_enfermeria_items` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_te_dia_tratamiento` FOREIGN KEY (`tratamiento_id`) REFERENCES `tratamientos_enfermeria` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `tratamientos_ejecucion_dosis`
--
ALTER TABLE `tratamientos_ejecucion_dosis`
  ADD CONSTRAINT `fk_te_dosis_diaria` FOREIGN KEY (`ejecucion_diaria_id`) REFERENCES `tratamientos_ejecucion_diaria` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_te_dosis_item` FOREIGN KEY (`tratamiento_item_id`) REFERENCES `tratamientos_enfermeria_items` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_te_dosis_tratamiento` FOREIGN KEY (`tratamiento_id`) REFERENCES `tratamientos_enfermeria` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `tratamientos_ejecucion_eventos`
--
ALTER TABLE `tratamientos_ejecucion_eventos`
  ADD CONSTRAINT `fk_te_evt_dia` FOREIGN KEY (`ejecucion_diaria_id`) REFERENCES `tratamientos_ejecucion_diaria` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_te_evt_trat` FOREIGN KEY (`tratamiento_id`) REFERENCES `tratamientos_enfermeria` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `tratamientos_enfermeria`
--
ALTER TABLE `tratamientos_enfermeria`
  ADD CONSTRAINT `fk_te_consulta` FOREIGN KEY (`consulta_id`) REFERENCES `consultas` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `tratamientos_enfermeria_items`
--
ALTER TABLE `tratamientos_enfermeria_items`
  ADD CONSTRAINT `fk_te_items_tratamiento` FOREIGN KEY (`tratamiento_id`) REFERENCES `tratamientos_enfermeria` (`id`) ON DELETE CASCADE;
COMMIT;
