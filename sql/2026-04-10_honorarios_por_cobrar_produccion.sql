-- SCRIPT PRODUCCION: Opcion B - Honorarios por cobrar
-- Ejecutar una sola vez en Produccion
-- Incluye DDL completo y restricciones necesarias
...
-- DML opcional de inicializacion: no se requiere backfill para aplicar Opcion B.
